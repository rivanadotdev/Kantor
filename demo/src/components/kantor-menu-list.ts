...
@customElement("kantor-menu-list")
export class KantorMenuList extends LitElement {
  ...
  render() {
    const setTitleComponent = (slotFilled: boolean) => {
      if (!slotFilled)
    ...
    return html`
      <div class="kantor-menu-list" part="main-container">
        ${setTitleComponent(this._isButtonSlotFilled)}
        <ul>
...
declare global {
  interface HTMLElementTagNameMap {
    "kantor-menu-list": KantorMenuList;
  }
}
